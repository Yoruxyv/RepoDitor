import { CircleHalfIcon, GithubLogoIcon, StarIcon, TranslateIcon } from "@phosphor-icons/react";
  ...
  return (
    <div className="flex flex-wrap items-center gap-2" aria-label={t("utility.group")}>
      <a
        ...
        className="inline-flex h-10 items-center gap-2 rounded-sm border border-line-strong bg-surface px-3 text-sm font-semibold text-secondary transition hover:border-accent hover:text-accent"
        href={PROJECT_URL}
        rel="noreferrer"
        target="_blank"
      >
      ...
      <label className="relative inline-flex h-10 items-center rounded-sm border border-line-strong bg-surface text-secondary focus-within:border-accent focus-within:text-accent">
      ...
      <label className="relative inline-flex h-10 items-center rounded-sm border border-line-strong bg-surface text-secondary focus-within:border-accent focus-within:text-accent">
        <TranslateIcon aria-hidden="true" className="pointer-events-none absolute left-3" size={16} />
